...
<body>
    <div class="main grid">
                    ...
                    <div class="header_items">
                        <div class="header_items-left">
                            <?php foreach($categorys as $category) { ?>
                                <a href="./pages/sanpham.php?maDanhMuc=<?php echo $category["maDanhMuc"]?>" class="header_item"><?php echo $category["tenDanhMuc"] ?></a>
                            <?php } ?>
                        </div>
                        <div class="header_items-right">
                            <a href="./pages/admin/login.php" class="header_item">
        ...
        <div class="body">
            <div class="welcome" style="background-image: url('./assests/img/welcome.jpg');">
                <div class="welcome-content">
                    <h2 class="welcome-content_title">Chào mừng đến với huyShop.</h2>
                    <a href="./pages/sanpham.php" class="welcome-content_button">Mua hàng ngay !</a>
                </div>
            </div>
                            ...
                            <?php foreach ($products as $product) : ?>
                                <div class="col l-3">
                                    <div class="product">
                                        ...
                                        <a href="./pages/chitietsanpham.php?maSanPham=<?php echo $product["maHangHoa"]?>" class="product_view">Xem chi tiết</a>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </div>
                    </div>
                    <!-- <a href="#!" class="products_more">Xem thêm</a> -->
                </div>
                <div class="features-bar">
                    <div class="features_items grid wide">
                        <div class="features_item">
                            <i class="fa-solid fa-truck-fast features_item-icon"></i>
                            <h2 class="features_item-title">Giao hàng nhanh</h2>
                        </div>
                        <div class="features_item">
                            <i class="fa-solid fa-headset features_item-icon"></i>
                            <h2 class="features_item-title">Hỗ trợ 24 / 7</h2>
                        </div>
                        <div class="features_item">
                            <i class="fa-solid fa-shield-halved features_item-icon"></i>
                            <h2 class="features_item-title">Bảo hành 2 năm</h2>
                        </div>
                        <div class="features_item">
                            <i class="fa-solid fa-handshake-simple features_item-icon"></i>
                            <h2 class="features_item-title">Free ship</h2>
                        </div>
                    </div>
                </div>
            </div>
